...
|---|---|---|---|---|
| — | `acquisition/youtube_downloader` (new layer, upstream of `ingestion/` — not part of design-v3's original build order; produces the local paths `ingestion/orchestrator` consumes as input) | — (not in design-v3) | Done | — |
...
| 4 | `processing/edge_builder` | D4/D5/D19 | Done | — |
